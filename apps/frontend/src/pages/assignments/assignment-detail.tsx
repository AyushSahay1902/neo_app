        ...
        setTimeout(
          () =>
            resolve({
              ...
              description:
                "Create a counter component using the useState hook. The component should display the current count and have buttons to increment and decrement the count.",
